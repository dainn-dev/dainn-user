        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimValue = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactValue = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    SessionToken = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    IpAddress = table.Column<string>(type: "TEXT", maxLength: 45, nullable: true),
                    UserAgent = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenValue = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2026, 5, 8, 8, 14, 3, 161, DateTimeKind.Utc).AddTicks(2904), "Full system access with all permissions", "Administrator", "users:read,users:write,users:delete,roles:read,roles:write,roles:delete,settings:read,settings:write", new DateTime(2026, 5, 8, 8, 14, 3, 161, DateTimeKind.Utc).AddTicks(2904) },
                    { new Guid("00000000-0000-0000-0000-000000000002"), new DateTime(2026, 5, 8, 8, 14, 3, 161, DateTimeKind.Utc).AddTicks(2904), "Standard user with basic permissions", "User", "profile:read,profile:write", new DateTime(2026, 5, 8, 8, 14, 3, 161, DateTimeKind.Utc).AddTicks(2904) },
                    { new Guid("00000000-0000-0000-0000-000000000003"), new DateTime(2026, 5, 8, 8, 14, 3, 161, DateTimeKind.Utc).AddTicks(2904), "Moderator with user management permissions", "Moderator", "users:read,users:write,profile:read,profile:write", new DateTime(2026, 5, 8, 8, 14, 3, 161, DateTimeKind.Utc).AddTicks(2904) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserContacts_UserId_ContactType_IsPrimary",
                table: "UserContacts",
                columns: new[] { "UserId", "ContactType", "IsPrimary" });
